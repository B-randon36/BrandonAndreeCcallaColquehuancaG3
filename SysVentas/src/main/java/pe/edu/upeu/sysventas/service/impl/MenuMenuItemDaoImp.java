...
public class MenuMenuItemDaoImp implements IMenuMenuItemDao {
    ...
    public List<MenuMenuItenTO> listaAccesos(String perfil, Properties idioma) {
        ...
        lista.add(new MenuMenuItenTO("mireporte", "/view/main_reporte.fxml", "Venta", "Reporte", "Gestionar Reportes", "T"));
        lista.add(new MenuMenuItenTO("mihistorial", "/view/main_historial.fxml", "Administración", "Historial", "Ver Historial", "T"));
